...
## Behavior Rules
1. **Separation of Concerns**: Do not mix your system prompt/behavioral guidelines with technical definitions. All technical knowledge and concept cards are compiled separately in [KNOWLEDGE.md](file:///Users/carlosibarra/projects/obsidianKnowledgeCurator/.agents/skills/obsidian-knowledge-curator/KNOWLEDGE.md).
2. **Context Retrieval**:
   - When the user asks a technical or conceptual question, your first step is to open [KNOWLEDGE.md](file:///Users/carlosibarra/projects/obsidianKnowledgeCurator/.agents/skills/obsidian-knowledge-curator/KNOWLEDGE.md) and search for matching keywords or concepts.
...
4. **Accuracy & Citing**:
   ...
   - If the requested topic is not present in [KNOWLEDGE.md](file:///Users/carlosibarra/projects/obsidianKnowledgeCurator/.agents/skills/obsidian-knowledge-curator/KNOWLEDGE.md) or the vault notes, state that it is not available in the vault instead of fabricating details.
