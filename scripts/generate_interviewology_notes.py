...
BOOK_FOLDER = BOOKS_ROOT / "Anna Papalia — Interviewology The New Science of Interviewing"
...
with open("temp/fetched_book_data.json", "r", encoding="utf-8") as f:
    book_data = json.load(f)

chapters_raw = book_data["chapters"]

def get_text(indices):
    return "\n\n".join([chapters_raw[i-1]["content"] for i in indices])
...
def create_ch00():
    content = f"""# Chapter 00 — Front Matter and Foundations
...
"""
    with open(BOOK_FOLDER / "Chapter 00 — Front Matter and Foundations.md", "w", encoding="utf-8") as f:
        f.write(content.strip() + "\n")

def create_ch01():
    content = f"""# Chapter 01 — An Interview Can Change Your Life
...
"""
    with open(BOOK_FOLDER / "Chapter 01 — An Interview Can Change Your Life.md", "w", encoding="utf-8") as f:
        f.write(content.strip() + "\n")

def create_ch02():
    content = f"""# Chapter 02 — How I Discovered the Four Interview Styles
...
"""
    with open(BOOK_FOLDER / "Chapter 02 — How I Discovered the Four Interview Styles.md", "w", encoding="utf-8") as f:
        f.write(content.strip() + "\n")

def create_ch03():
    content = f"""# Chapter 03 — Why Its Important to Know Your Interview Style
...
"""
    with open(BOOK_FOLDER / "Chapter 03 — Why Its Important to Know Your Interview Style.md", "w", encoding="utf-8") as f:
        f.write(content.strip() + "\n")

def create_ch04():
    content = f"""# Chapter 04 — The Four Interview Styles
...
"""
    with open(BOOK_FOLDER / "Chapter 04 — The Four Interview Styles.md", "w", encoding="utf-8") as f:
        f.write(content.strip() + "\n")

def create_ch05():
    content = f"""# Chapter 05 — The Charmer
...
"""
    with open(BOOK_FOLDER / "Chapter 05 — The Charmer.md", "w", encoding="utf-8") as f:
        f.write(content.strip() + "\n")

def create_ch06():
    content = f"""# Chapter 06 — Interviewing with a Charmer
...
"""
    with open(BOOK_FOLDER / "Chapter 06 — Interviewing with a Charmer.md", "w", encoding="utf-8") as f:
        f.write(content.strip() + "\n")

def create_ch07():
    content = f"""# Chapter 07 — The Challenger
...
"""
    with open(BOOK_FOLDER / "Chapter 07 — The Challenger.md", "w", encoding="utf-8") as f:
        f.write(content.strip() + "\n")

def create_ch08():
    content = f"""# Chapter 08 — Interviewing with a Challenger
...
"""
    with open(BOOK_FOLDER / "Chapter 08 — Interviewing with a Challenger.md", "w", encoding="utf-8") as f:
        f.write(content.strip() + "\n")

def create_ch09():
    content = f"""# Chapter 09 — The Examiner
...
"""
    with open(BOOK_FOLDER / "Chapter 09 — The Examiner.md", "w", encoding="utf-8") as f:
        f.write(content.strip() + "\n")

def create_ch10():
    content = f"""# Chapter 10 — Interviewing with an Examiner
...
"""
    with open(BOOK_FOLDER / "Chapter 10 — Interviewing with an Examiner.md", "w", encoding="utf-8") as f:
        f.write(content.strip() + "\n")

def create_ch11():
    content = f"""# Chapter 11 — The Harmonizer
...
"""
    with open(BOOK_FOLDER / "Chapter 11 — The Harmonizer.md", "w", encoding="utf-8") as f:
        f.write(content.strip() + "\n")

def create_ch12():
    content = f"""# Chapter 12 — Interviewing with a Harmonizer
...
"""
    with open(BOOK_FOLDER / "Chapter 12 — Interviewing with a Harmonizer.md", "w", encoding="utf-8") as f:
        f.write(content.strip() + "\n")

def create_ch13():
    content = f"""# Chapter 13 — Discoveries and Long-Term Insights
...
### 1. Introducción
El decimotercer capítulo inaugura la Tercera Parte del libro synthesizando los hallazgos a largo plazo acumulados por Anna Papalia tras años de investigación psicométrica, consultoría ejecutiva y análisis de datos en *Interviewology*. La autora reflexiona sobre las implicaciones profundas de los estilos de entrevista en la equidad de contratación, la diversidad en las organizaciones y el desarrollo del liderazgo corporativo.
...
"""
    with open(BOOK_FOLDER / "Chapter 13 — Discoveries and Long-Term Insights.md", "w", encoding="utf-8") as f:
        f.write(content.strip() + "\n")

def create_ch14():
    content = f"""# Chapter 14 — Appendix and Reference Framework
...
"""
    with open(BOOK_FOLDER / "Chapter 14 — Appendix and Reference Framework.md", "w", encoding="utf-8") as f:
        f.write(content.strip() + "\n")
...
print("✓ All 15 Chapter notes created successfully!")
